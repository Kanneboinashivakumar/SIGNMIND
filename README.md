...
SIGNMIND is a 100% static, client-side web application. It requires zero backend servers to run, making deployment instantaneous and cost-free.

### Option A: Vercel (Recommended)
1. Push this repository to GitHub.
2. Visit [Vercel](https://vercel.com/) and click **Add New Project**.
3. Import `Kanneboinashivakumar/SIGNMIND`.
4. Vercel will automatically detect **Vite**:
   - **Framework Preset**: `Vite`
   - **Build Command**: `npm run build`
   - **Output Directory**: `dist`
5. Click **Deploy**. Your app will be live on a global CDN with SSL enabled.
...
1. In `vite.config.ts`, configure your base repository path:
   ```ts
   ...
   ```
2. Enable GitHub Pages in your repository settings under **Source $\rightarrow$ GitHub Actions**.

### Option D: Docker / Google Cloud Run
A standard Nginx container can serve the compiled output:
```dockerfile
# Stage 1: Build
